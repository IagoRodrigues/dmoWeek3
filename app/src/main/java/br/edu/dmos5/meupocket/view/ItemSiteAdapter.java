...
public class ItemSiteAdapter {* especificar o comportamento dos elementos da Lista
 */
public class ItemSiteAdapter extends ArrayAdapter {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent)
    {
        ...
        if (convertView == null) {
            /*
                O objeto convertView será nulo quando ainda não foi instânciado, ou seja, em nosso
                exemplo é invocado quando o site ainda não está na ListView, dessa forma, é preciso
                instância o objeto (inflar um novo item_lista_pocket) e obter as referências de cada
                elemento de layout.
            */
            ...
            */
            ...
            /*
                ...
                holder para o holder que foi armazenado na tag da View, sendo necessário apenas
                recuperar a tag.
            */
    ...
    /*
        A classe ViewHolder é uma inner class, ou seja, uma classe interna. Ela consegue "enchergar"
        tudo da classe ItemSiteAdapter. Vamos utilizar essa classe para armazenar as referências dos
        elementos de layout que estão no layout item_lista_pocket.
    */
